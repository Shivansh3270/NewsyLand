...
function App() {
  ...
  return (
    <div className="App">
      ...
      />
        <Routes>
          <Route  path="/" element={<><div className="container"><div className="card-group" style={{ margin: '35px 0px -60px', marginTop: '90px', padding: '10px' }}><WeatherCard weather={weather}></WeatherCard></div></div><News setProgress={setProgress} key="general" pageSize={pageSize} country="IN" language="en" query={searchQuery} category="news" /></>}/> 
